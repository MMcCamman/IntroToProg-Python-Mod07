...
#   McCamman, 2024-05-26, Completed Assignment
# ------------------------------------------------------------------------------------------ #
import json
...
class Person:
    ...
    ChangeLog:
        - McCamman, 2024-05-25: Created the class.
    """
...
class Student(Person):
    ...
    Properties:
        first_name (str): The student's first name.
        last_name (str): The student's last name.
        course_name (float): The course the student ie enrolled in.

    ChangeLog: (Who, When, What)
    McCamman, 2024-05-28, Created Class
    """
...
class FileProcessor:
    ...
    McCamman, 2024-05-28, Added missing file handler
    """
    @staticmethod
